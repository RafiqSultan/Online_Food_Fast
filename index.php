...
<body class="Home">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item"><a href="php/login.php" class="nav-link active">Login</a> </li>
                        <li class="nav-item"><a href="php/register.php" class="nav-link active">Register</a> </li>
    ...
    <!--*=======================
        *Home  Section 
    ==========================-->
    <section class="home bg-image" data-image-src="images/img/pimg.jpg">
        <div class="home-inner">
            <div class="container text-center home-text font-white">
    ...
    <!--*=======================
        *Popular Dishes of the Month  Section
    ==========================-->
